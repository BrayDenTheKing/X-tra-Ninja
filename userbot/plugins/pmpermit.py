...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "**No name set yet nibba, check pinned message in** @ReportNotification"
...
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](https://t.me/MrSemmy)\n\n"
                    "`Hello, i am 🤖 Calvil please wait for my response and dont spam my pm if u dont listen and get block use @ReportusBot Thanks 🥴🥴,`"
